...
```bash
npm install -g @vibe-doc/cli
# or
npx @vibe-doc/cli scan
```
...
Found a bug? Missing a document type? Want to improve the classifier? Open an issue or PR at the main 626Labs repository.
