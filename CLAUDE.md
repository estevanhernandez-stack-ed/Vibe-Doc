...
- **Voice:** Builder-to-builder, second person, sentence case. No "empower / leverage / seamlessly / unlock / unleash." Em-dashes minimal; commas, periods, colons by default. No emoji in UI copy or marketing surfaces. Tagline: *Imagine Something Else.*
...
This project is indexed by GitNexus as **vibe-doc** (974 symbols, 1346 relationships, 33 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/vibe-doc/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/vibe-doc/context` | Codebase overview, check index freshness |
| `gitnexus://repo/vibe-doc/clusters` | All functional areas |
| `gitnexus://repo/vibe-doc/processes` | All execution flows |
| `gitnexus://repo/vibe-doc/process/{name}` | Step-by-step execution trace |
